...
- Put Vitsel.clap in a directory yadaw scans, e.g.:
  - /storage/emulated/0/Android/data/org.mlm.yadaw/files/plugins/clap/ (need adb or shizuku access, yadaw supports it by copying it from external to internal, since newer android devices open everything under storage/emulated/0 in noexec mode)
